...
- **Repository Name:** Terraform-Cloud-Project
...
git clone https://github.com/stacksimplify/Terraform-Cloud-Project.git
```
...
- List of files to be copied
  ...
  - outputs.tf
  - ami-datasource.tf
- Destination Location: Newly cloned github repository folder in your local desktop `Terraform-Cloud-Project`
...
https://github.com/stacksimplify/Terraform-Cloud-Project.git
```
...
- **Email Address:** sanketnalage88@gmail.com
